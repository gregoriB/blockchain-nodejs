class TestSuite {
    ...
    logTestResults(results) {
        ...
        console.log(`
            ...
            ${tallies.tests.passed + tallies.tests.failed} TESTS FINISHED

            *
            * ${tallies.assertions.passed} Assertions Passed
            * ${tallies.assertions.failed} Assertions Failed
            * 
            * ${tallies.tests.passed} Tests Passed
            * ${tallies.tests.failed} Tests Failed
            * 
        `)
    }
}
